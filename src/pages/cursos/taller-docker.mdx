...
content:
  - name: "Fundamentos de Docker"
    link: "1-fundamentos-de-docker"
  - name: "Instalación de Docker"
    link: "2-instalación-de-docker"
  - name: "Primeros pasos con Docker"
    link: "3-primeros-pasos-con-docker"
  - name: "Gestión de contenedores"
    link: "4-gestión-de-contenedores"
  - name: "Crear una BD a partir de una Imagen"
    link: "5-crear-una-bd-a-partir-de-una-imagen"
  - name: "Construcción de imágenes con Dockerfile"
    link: "6-construcción-de-imágenes-con-dockerfile"
  - name: "Docker Compose"
    link: "7-docker-compose"
  - name: "Casos de uso de Docker"
    link: "8-casos-de-uso-de-docker"
  - name: "Ejercicio práctico del taller"
    link: "9-ejercicio-práctico-del-taller"
---
...
- Esto crea un contenedor de _Postgres_ con la siguiente configuración:
  - Host : localhost
  - Puerto: 5432
  - Database: postgres
  - Username: postgres
