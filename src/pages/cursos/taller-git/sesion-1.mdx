---
layout: ../[slug].astro
title: "Introducción a Git - Sesión 1"
author: "Neil Graneros"
date: "09 Sep 2025"
colaboration:
  - name: "Nucleo GNU/Linux"
    link: "https://www.nucleognulinux.org/"
    imageUri: "https://i.postimg.cc/kM8Jgm4v/logo-nucleo.png"
    color: "#e7e8e9"
---

## 📋 Descripción

En este apartado se encuentra el material relacionado a la **primera sesión** del taller de GIT.
...
<iframe
  src="https://drive.google.com/file/d/1aAs5mwlfbmW-4eOqX343uuAPVNf29TVj/preview"
  width="100%"
  height="480"
  allow="autoplay"
></iframe>
...
### 🚨 Errores comunes y soluciones al crear un repositorio remoto

#### 1. Error al crear la conexión entre los repositorios:

Si es la primera vez, que creamos un repositorio remoto en GitHub. Si al momento de realizar la conexión (`push`) del repositorio local al remoto, nos sale este error ⚠️:
...
- Haz click en `"Generate new token (classic)"`
  [![image.png](https://i.postimg.cc/rw8LPc8d/image.png)](https://postimg.cc/fJgFVGSZ)
- Dale nombre al token y selecciona su tiempo de expiración. (ej: 30 días o "no expiration")
  [![image.png](https://i.postimg.cc/NjYgvmxj/image.png)](https://postimg.cc/w7fKhtPC)
...
- Y copia el token generado. **Ten cuidado que se muestra solo una vez**. [![image.png](https://i.postimg.cc/YSPK0WQg/image.png)](https://postimg.cc/Y4Qyyjnq)
- La próxima vez que hagas `git push` o `git pull`, Git te pedirá tu `usuario` y `token`:
  ```bash
